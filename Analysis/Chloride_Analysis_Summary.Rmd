...
On the whole, this model is OK, but not great. It has heavy tailed, skewed 
...
might also consider adding a "high rainfall"  term, rather than fitting
...
evidence for lack of complete independence between residuals and predictors.
This model is adequate, but not great.  For careful work, we should probably use
